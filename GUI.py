...
#button 
Button(top_frame, text='Choose Folder', font=labelfont, width=11,command=choseWav).place(x=130, y=10)
Button(top_frame, text='Choose Folder', font=labelfont, width=11,command=choseWav).place(x=130, y=90)
